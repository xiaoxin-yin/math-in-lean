...
theorem ex1 (α : Type) [One₁ α] : α := One₁.one

theorem ex2 (α : Type) [One₁ α] := (One₁.one : α)

@[inherit_doc]
notation "𝟙" => One₁.one

theorem ex3 {α : Type} [One₁ α] : α := 𝟙

theorem ex4 {α : Type} [One₁ α] : (𝟙 : α) = 𝟙 := rfl
...
theorem ex5 {α : Type} [Semigroup₁ α] (a b : α) : α := a ⋄ b
...
theorem ex6 {α : Type} [Semigroup₂ α] (a b : α) : α := a ⋄ b
...
theorem ex7 {α : Type} [DiaOneClass₁ α] (a b : α) : Prop := a ⋄ b = 𝟙
...
theorem ex9 {M : Type} [Monoid₁ M] {a b c : M} (hba : b ⋄ a = 𝟙) (hac : a ⋄ c = 𝟙) : b = c := by
...
theorem ex10 (n : ℕ) (m : ℤ) : SMul.smul (self := mySMul) n m = n * m := rfl
